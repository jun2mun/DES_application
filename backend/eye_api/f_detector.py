...
class eye_blink_detector():
    def __init__(self):
        ...
        notebook = 'C:/Users/owner/Desktop/portfolio/eye_electron_app/backend/eye_api/model_landmarks/shape_predictor_68_face_landmarks.dat'
        self.predictor_eyes = dlib.shape_predictor(notebook)
