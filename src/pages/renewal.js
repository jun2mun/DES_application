...
class RenewalPage {
    ...
    render(){
        ...
        */
        ...
        ScreenTime(main,this.data,this.total_time) // 스크린 타임 컴포넌트 출력

        most_used(main,this.data) // most used 컴포넌트 출력

        predicted(main,this.data)

        TimeGraph(main,this.route,'screen',this.data2)
...
function most_used($div,data){
    // 변수 초기화 //
    const dataset = []
    const the_top_few = 2 // 상위 $'{the_top_few}개를 dashboard에 보이기
