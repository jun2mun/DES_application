    ...
    def time_handler(self):
        ...
        if status:
            ...
            if self.stack_time >= 1:#10초
                ...
                self.SQL.init('second_main_1',f'CREATE TABLE process(id INTEGER PRIMARY KEY, count1min Integer, groupid text, date text, start_time text, end_time text)')
